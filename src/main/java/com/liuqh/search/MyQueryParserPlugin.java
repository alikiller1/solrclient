...
public class MyQueryParserPlugin extends QParserPlugin {
  ...
  /*  List<String> params;
    ...
    public QParser createParser(String s, SolrParams solrParams, SolrParams solrParams1, SolrQueryRequest solrQueryRequest) {
    	...
    	System.out.println("solrParams==="+solrParams);
    	System.out.println("solrParams1==="+solrParams1);
    	System.out.println("solrQueryRequest==="+solrQueryRequest);
    	return  new MyParser(s,solrParams,solrParams1,solrQueryRequest);
    }
