 ...
 */
public class OffsetQueryParserPlugin extends QParserPlugin {

  public static final String NAME = "offsetphrase";
...
class ComplexPhraseQParser extends QParser {
  ...
  OffsetPhraseQueryParser lparser;
  ...
  public Query parse() throws SyntaxError {
    ...
    lparser = new OffsetPhraseQueryParser(defaultField, getReq().getSchema().getQueryAnalyzer());
