...
public class SolrMain {
	...
	static {/*
			 * Properties properties = new Properties(); String path =
			 * SolrMain.class.getResource("/").getFile().toString() +
			 * "solr.properties"; try { FileInputStream fis = new
			 * FileInputStream(new File(path)); properties.load(fis); SOLR_URL =
			 * properties.getProperty("SOLR_URL"); SOLR_CORE =
			 * properties.getProperty("SOLR_CORE"); } catch (Exception e) {
			 * e.printStackTrace(); }
			 */
	}
	 ...
	 * @throws Exception
	 */
	public static void addDocument(Map<String, String> map) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void addDocumentByBean(List<Person> persons) throws Exception {
		HttpSolrClient solrClient = getSolrClient("/" + SOLR_CORE);
	 ...
	 * @throws Exception
	 */
	public static void commitAndCloseSolr(HttpSolrClient solrClient) throws Exception {
		solrClient.commit();
		solrClient.close();
	}
